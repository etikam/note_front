...
export const endpoints = {
  ...
  academics: {
    ...
    semesters: `${API_PREFIX}/academics/semesters/`,
    semesterDetail: (id) => `${API_PREFIX}/academics/semesters/${id}/`,
    ...
    courseAssignmentSemesters: `${API_PREFIX}/academics/course-assignment-semesters/`,
