...
const STATS = [
  { num: "1989", label: "Année de fondation", icon: "🗓️" },
  { num: "2", label: "Départements", icon: "🏛️" },
  { num: "LMD", label: "Système académique", icon: "🎓" },
  { num: "6", label: "Semestres (Licence)", icon: "📚" },
];
...
const ADMISSION_STEPS = [
  { n: "01", title: "Prérequis", desc: "Baccalauréat complet ou diplôme équivalent. Bonne maîtrise du français requise.", icon: "📋" },
  { n: "02", title: "Dépôt dossier", desc: "Remise du dossier au service de scolarité selon le calendrier d'inscription officiel.", icon: "📁" },
  { n: "03", title: "Évaluation", desc: "Examen du dossier par les comités de programmes et sélection des candidats retenus.", icon: "🔍" },
  { n: "04", title: "Diplôme LMD", desc: "Diplôme décerné après validation de tous les crédits. 6 à 8 semestres selon la filière.", icon: "🎓" },
];
      ...
      <section style={{ padding: "6rem 3rem", background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {[
              { icon: "🤝", label: "Partenariat", val: "France – Guinée" },
              { icon: "📜", label: "Arrêté", val: "N°632/MEN/89" },
              { icon: "🎓", label: "Cursus", val: "Système LMD" },
              { icon: "📍", label: "Localisation", val: "Dixinn, Conakry" },
            ].map((item) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }}>
            {ADMISSION_STEPS.map((s, i) => (
              <div key={s.n} style={{ background: "#F8FAFF", border: "1px solid #E2E8F0", borderRadius: 14, padding: "2rem 1.5rem", position: "relative", textAlign: "center" }}>
                <div style={{ width: 48, height: 48, background: "#DBEAFE", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, margin: "0 auto 16px" }}>{s.icon}</div>
      ...
      <section id="contact" style={{ padding: "6rem 3rem", background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            {[
              { icon: "📍", title: "Adresse", lines: ["Dixinn, Conakry 33139", "Guinée"], color: "#1D4ED8" },
              { icon: "📞", title: "Téléphone", lines: ["+224 624 08 45 01", "+224 657 99 43 57"], color: "#0369A1" },
              { icon: "✉️", title: "Email", lines: ["direction@ci.edu.gn"], color: "#1E40AF" },
            ].map((c) => (
